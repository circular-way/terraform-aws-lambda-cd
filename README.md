...
| <a name="input_lambda_create"></a> [lambda_create](#input_lambda_create)                                              | Create a target lambda for the build package created on the worker. Disable to handle build artefacts differently, eg: static website on s3                                                                          | `bool`                                                                                  | `true`                                              |    no    |
